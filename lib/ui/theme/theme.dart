...
const Color territoryColor_ = Color(0xFF001022);
...
const Color territoryColorDark = Color(0xFF001022);
...
extension ColorPrefs on ColorScheme {
  ...
  Color get mainGold => _getColor(brightness,
      lightColor: mainGoldColor, darkColor: mainGoldColor);

  Color get mainBrown => _getColor(brightness,
      lightColor: mainBrownColor, darkColor: mainBrownColor);
